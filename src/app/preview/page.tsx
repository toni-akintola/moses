...
import { ageAtom, educationsAtom, emailAtom, experiencesAtom, nameAtom, numberAtom, proficiencyAtom, skillsAtom } from '@/utils/atoms'
 type Props = {}
...
const Preview = (props: Props) => {
  ...
  return (
    <div>
        <Resume age={age} name={name} number={number} email={email} proficiency={proficiency} educations={educations} experiences={experiences} skills={skills} />
    </div>
  )
}
